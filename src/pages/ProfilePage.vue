...
const name = ref(localStorage.getItem('korean-profile-name') || '')
const showConfirm = ref(false)

function saveName() {
  localStorage.setItem('korean-profile-name', name.value)
}
...
function resetProgress() {
  localStorage.removeItem('korean-progress')
  localStorage.removeItem('korean-srs')
  localStorage.removeItem('korean-achievements')
  localStorage.removeItem('korean-review-sessions')
  localStorage.removeItem('korean-xp-date')
  localStorage.removeItem('korean-xp-today')
